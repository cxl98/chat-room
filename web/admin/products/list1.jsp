...
<form id="Form1" name="Form1"
      action="${pageContext.request.contextPath}/SearchBookServlet" method="post">
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td height="22" align="center"  class="ta_01">
                            商品编号</td>
                        <td class="ta_01" ><input type="text" name="id" size="15" value="" id="Form_userName" class="bg" />
                        </td>
                        <td height="22" align="center"  class="ta_01">
                            类别：</td>
                        <td class="ta_01" ><select name="category" id="category">
                    ...
                    <tr>
                        ...
                        <td class="ta_01" ><input type="text" name="name" size="15" value="" id="Form1_userName" class="bg" />
                        </td>
                        <td height="22" align="center"  class="ta_01">
                            价格区间(元)：</td>
                        <td class="ta_01" ><input type="text" name="minprice" size="10" value="" />-
